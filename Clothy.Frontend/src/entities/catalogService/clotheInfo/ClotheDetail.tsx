...
import type { IClotheDetailDTO } from "../interfaces/clothe/IClotheDetailDTO.ts";
import { useEffect, useMemo, useState, useRef } from "react";
import styles from "./ClotheDetail.module.css";
import type { IColorReadDTO } from "../interfaces/color/IColorReadDTO.ts";
import type { ISizeReadDTO } from "../interfaces/size/ISizeReadDTO.ts";
