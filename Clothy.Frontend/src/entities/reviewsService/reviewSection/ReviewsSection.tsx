...
import type { IReviewStatistic } from "../interfaces/IReviewStatistic.ts";
...
import {type IQuestionFilters, questionApi} from "../../../app/api/questionApi.ts";
...
const ReviewsSection: React.FC<ReviewsSectionProps> = ({ clotheId, slug, initialReviews, statistics, initialQuestions }) => {
    ...
    const handleQuestionPageChange = async (page: number) => {
        ...
        try {
            ...
            const newQuestions = await questionApi.getQuestionsAsync(filters);
