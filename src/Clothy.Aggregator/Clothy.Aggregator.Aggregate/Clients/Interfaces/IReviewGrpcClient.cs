...
namespace Clothy.Aggregator.Aggregate.Clients.Interfaces
{
    ...
    {
        Task<PendingReviewsCountGrpcResponse> GetPendingReviewsCountAsync(CancellationToken cancellationToken = default);
        Task<QuestionsWithoutAnswerGrpcResponse>  GetQuestionsWithoutAnswerAsync(CancellationToken cancellationToken = default);
