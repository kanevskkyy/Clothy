...
{
    public interface IClothingTypeRepository : IGenericRepository<ClothingType>
    {
        ...
        Task<Dictionary<ClothingType, int>> GetClothingTypeCountWithStockAsync(CancellationToken cancellationToken = default);
    }
}
